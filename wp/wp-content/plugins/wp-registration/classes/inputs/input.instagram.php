...
class NM_Instagram extends NM_Inputs_wpregisration{
	...
	private function get_settings(){
		...
		return array (
				...
				'button_label_import' => array (
						'type' => 'text',
						'title' => __ ( 'Button label', 'wp-registration' ),
						'desc' => __ ( 'Type button label e.g: Import Photos', 'wp-registration' ) 
				),
				'button_class' => array (
						'type' => 'text',
						'title' => __ ( 'Button class', 'wp-registration' ),
						'desc' => __ ( 'Type class for import button', 'wp-registration' )
				),
